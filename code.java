...
class SignUp extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == submit) {
            try {
                String url = "jdbc:mysql://127.0.0.1:3308/info";
...
class LogIn extends JFrame implements ActionListener {
    ...
    JTextField usertf;
    JPasswordField pf;
    JLabel userid, pass, wrongPass, wrongid, log;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == login) {
            try {
                Class.forName("com.mysql.jdbc.Driver");
                Connection con = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3308/info", "root", "riya");
...
class GeneralMainScreen extends JFrame implements ActionListener {
    ...
    GeneralMainScreen(String id) {
        ...
        profile = new JLabel();
        profile.setIcon(new ImageIcon("userimg.png"));
...
class generalDisplay extends JFrame implements ActionListener {
    ...
    generalDisplay(String id) {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3308/info", "root", "riya");
